...
const services = [
  ...
  },
  {
    ...
    note: 'React, TypeScript, GSAP, and performance budgets that actually hold.',
  },
  {
  ...
  },
  {
    ...
    note: 'A second pair of eyes on architecture, accessibility, and craft.',
  },
]
        ...
        <section className="md:col-span-9">
          ...
          <div className="max-w-2xl mb-20">
            <p className="text-[17px] md:text-[18px] leading-[1.65] text-ink/80 mb-6">
              <span className="text-line-mask inline-block">
                <span className="text-char-slide">
                  ...
                  digital experiences for studios, founders, and editorial
                  teams who care about how a site feels, not just how it looks
                  in a screenshot.
                </span>
              </span>
            </p>
            <p className="text-[15px] md:text-[16px] leading-[1.7] text-ink/65">
              <span className="text-line-mask inline-block">
                <span className="text-char-slide">
                  Every project is built from the ground up — no templates, no
                  short-cuts, no borrowed grids. Just type, motion, and code,
                  tuned until the details stop getting in the way of the work.
                </span>
              </span>
            </p>
          </div>
          ...
          {/* Tools line */}
          <div className="mt-16 flex flex-col md:flex-row items-start md:items-end justify-between gap-6">
            <p className="text-[15px] text-ink/60 max-w-md leading-relaxed">
              <span className="text-line-mask inline-block">
                <span className="text-char-slide">
                  Recent tools of choice — React, TypeScript, GSAP, Tailwind,
                  Figma, and a notebook that travels everywhere.
                </span>
              </span>
            </p>
